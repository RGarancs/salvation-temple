...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'statistics.baptisms': 'Крещений в прошлом году',
    ...
    'statistics.sundaySchool.hover': 'Каждое воскресенье 35 детей изучают Библию в увлекательной форме. Занятия проходят во время служения для детей разных возрастов.',
    'statistics.sundaySchool.learnMore': 'Узнать о воскресной школе',
    'statistics.summerCamp': 'В летних лагерях',
    'statistics.summerCamp.hover': 'Каждое лето более 200 детей и подростков участвуют в наших лагерях, где они познают Бога через игры, творчество и общение.',
