...
const translations: Record<Language, Record<string, string>> = {
  ...
  lv: {
    ...
    'hero.changing.minds': 'Mainīts Domāšana',
    ...
    'about.vision.text': 'Būt dzīvai ticīgo kopienai, kas pārveido dzīves caur Kristus mīlestību, radot telpu garīgai izaugsmei un kalpošanai citiem.',
    'about.mission.title': 'Mūsu Misija',
    'about.mission.text': 'Nest Evaņģēliju, veidot Kristus mācekļus un kalpot sabiedrībai caur mīlestību, žēlsirdību un praktisku palīdzību.',
    'about.values.title': 'Mūsu Vērtības',
    'about.values.faith.title': 'Ticība',
    'about.values.faith.desc': 'Mēs dzīvojam ticībā Dievam un Viņa Vārdam kā visas dzīves pamatam.',
    'about.values.love.title': 'Mīlestība',
    'about.values.love.desc': 'Kristus mīlestība ir dzinējspēks visam, ko mēs darām.',
    'about.values.community.title': 'Kopiena',
    'about.values.community.desc': 'Mēs esam radīti attiecībām un kalpošanai viens otram.',
    'about.values.growth.title': 'Izaugsme',
    'about.values.growth.desc': 'Mēs tiecamies uz pastāvīgu garīgo izaugsmi un attīstību.',
