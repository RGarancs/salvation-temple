...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    // About Section
    'about.title': 'О нас',
    'about.subtitle': 'Познакомьтесь с нашей церковью, её видением и ценностями',
    'about.vision.title': 'Наше Видение',
    'about.vision.text': 'Быть живой общиной верующих, которая преображает жизни через любовь Христа, создавая пространство для духовного роста и служения ближним.',
    'about.mission.title': 'Наша Миссия',
    'about.mission.text': 'Нести Евангелие, созидать учеников Христа и служить обществу через любовь, милосердие и практическую помощь.',
    'about.values.title': 'Наши Ценности',
    'about.values.faith.title': 'Вера',
    'about.values.faith.desc': 'Мы живём верой в Бога и Его Слово как основу всей жизни.',
    'about.values.love.title': 'Любовь',
    'about.values.love.desc': 'Любовь Христа — движущая сила всего, что мы делаем.',
    'about.values.community.title': 'Община',
    'about.values.community.desc': 'Мы созданы для отношений и служения друг другу.',
    'about.values.growth.title': 'Рост',
    'about.values.growth.desc': 'Мы стремимся к постоянному духовному росту и развитию.',

    // History Section
    'history.title': 'История Церкви',
    'history.subtitle': 'Храм Спасения — крупнейший баптистский молитвенный дом в Латвии с богатой историей',
    'history.founder': 'Основатель',
    'history.fetler.name': 'Вильям Фетлер',
    'history.fetler.desc': 'Идейный лидер OBDS, который уделял большое внимание евангелизации, особенно в Латгалии, а также миссионерской работе среди русских, поляков и других этнических меньшинств.',
    'history.fetler.caption': 'Вильям Фетлер и Даугавпилсская Белая церковь — плод его миссионерской работы в Латгалии',
    'history.obds.title': 'Вторая Баптистская Уния (OBDS)',
    'history.obds.text': 'После раскола «баптисты пробуждения» основали Вторую Баптистскую Унию (OBDS). В Риге к OBDS относились церкви Матея, Агенскалнса, Атмодас (Храм Спасения) и Голгаты. В 1929 году LBDS насчитывала 77 церквей с 6766 членами, а OBDS — 39 церквей с 3763 членами. Благодаря активной евангелизационной работе число членов OBDS росло быстрее.',
    'history.evangelization.title': 'Евангелизация и Миссия',
    'history.evangelization.text': 'Для проповеди Евангелия OBDS использовала кинотеатры, народные дома, рыночные площади и другие публичные места. В Риге и Лиепае проводились масштабные библейские шествия. Крещения проходили в различных публичных местах у моря, на берегах озёр и рек.',
    'history.tent.caption': 'Вверху — Библейское шествие OBDS по улицам Риги; внизу — евангелизационная палатка во дворе Храма Спасения',
    'history.temple.title': 'Храм Спасения',
    'history.temple.text': 'В 1927 году в Риге на улице Лачплеша 117 было завершено строительство крупнейшего баптистского молитвенного дома — Храма Спасения. На открытии присутствовали многие почётные гости, включая послов США и Великобритании в Латвии. Главный зал вмещал более 2000 человек. Богослужения проводились на четырёх языках — латышском, русском, немецком и польском.',
    'history.building.caption': 'Храм Спасения — крупнейший баптистский молитвенный дом в Латвии, 1927 г.',

    // Statistics Section
    'statistics.title': 'Наша Община',
    'statistics.subtitle': 'Мы — семья верующих разных возрастов и поколений',
    ...
    'gallery.followUs': 'Следите за нами в социальных сетях',
    ...
    'contacts.youthAccounts': 'Молодёжные аккаунты',
  ...
  en: {
    ...
    'about.subtitle': 'Get to know our church, its vision and values',
    'about.vision.title': 'Our Vision',
    'about.vision.text': 'To be a living community of believers that transforms lives through the love of Christ, creating space for spiritual growth and service to others.',
    'about.mission.title': 'Our Mission',
    'about.mission.text': 'To share the Gospel, make disciples of Christ, and serve the community through love, mercy, and practical help.',
    'about.values.title': 'Our Values',
    'about.values.faith.title': 'Faith',
    'about.values.faith.desc': 'We live by faith in God and His Word as the foundation of all life.',
    'about.values.love.title': 'Love',
    'about.values.love.desc': 'The love of Christ is the driving force behind everything we do.',
    'about.values.community.title': 'Community',
    'about.values.community.desc': 'We are created for relationships and service to one another.',
    'about.values.growth.title': 'Growth',
    'about.values.growth.desc': 'We strive for constant spiritual growth and development.',

    // History Section
    'history.title': 'Church History',
    'history.subtitle': 'Salvation Temple — the largest Baptist church building in Latvia with a rich history',
    'history.founder': 'Founder',
    'history.fetler.name': 'William Fetler',
    'history.fetler.desc': 'The ideological leader of OBDS, who paid great attention to evangelization, especially in Latgale, as well as missionary work among Russians, Poles, and other ethnic minorities.',
    'history.fetler.caption': 'William Fetler and the Daugavpils White Church — the fruit of his missionary work in Latgale',
    'history.obds.title': 'Second Baptist Union (OBDS)',
    'history.obds.text': 'After the split, "revival Baptists" founded the Second Baptist Union (OBDS). In Riga, OBDS included Matthew, Agenskalns, Atmoda (Salvation Temple), and Golgotha churches. In 1929, LBDS had 77 churches with 6,766 members, while OBDS had 39 churches with 3,763 members. Due to active evangelization work, OBDS membership grew faster.',
    'history.evangelization.title': 'Evangelization and Mission',
    'history.evangelization.text': 'For preaching the Gospel, OBDS used cinemas, community centers, marketplaces, and other public places. Large Bible marches were held in Riga and Liepaja. Baptisms took place in various public places by the sea, on the shores of lakes and rivers.',
    'history.tent.caption': 'Top — OBDS Bible march through Riga streets; bottom — evangelization tent in the Salvation Temple courtyard',
    'history.temple.title': 'Salvation Temple',
    'history.temple.text': 'In 1927, the largest Baptist church building — Salvation Temple — was completed in Riga at Lāčplēša Street 117. Many distinguished guests attended the opening, including US and UK ambassadors to Latvia. The main hall could accommodate more than 2,000 people. Services were held in four languages — Latvian, Russian, German, and Polish.',
    'history.building.caption': 'Salvation Temple — the largest Baptist church building in Latvia, 1927',

    // Statistics Section
    'statistics.title': 'Our Community',
    'statistics.subtitle': 'We are a family of believers of different ages and generations',
    'statistics.total': 'Total Members',
    'statistics.children': 'Children',
    'statistics.youth': 'Youth',
    'statistics.adults': 'Adults',
    'statistics.seniors': 'Seniors',
    ...
    'gallery.subtitle': 'Moments from our church life',
    'gallery.followUs': 'Follow us on social media',
