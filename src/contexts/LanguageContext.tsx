...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'about.values.christ.desc': 'Наш фокус во всем, что мы делаем',
    'about.values.christ.sub1': 'Кто Он был, что Он сделал',
    'about.values.christ.sub2': 'Что Он делает сейчас через Духа Святого',
    'about.values.bible.title': 'Библия — наша истина',
    'about.values.bible.desc': 'Слово Божье — основа нашей веры',
    'about.values.bible.sub1': 'Евангелие',
    'about.values.bible.sub2': 'Все книги Библии',
    'about.values.discipleship.title': 'Ученичество',
    'about.values.discipleship.desc': 'Рост через наставничество',
    'about.values.discipleship.sub1': 'Как наставничество',
    'about.values.discipleship.sub2': 'Как общение с целью духовного роста',
    'about.values.mission.title': 'Миссия',
    'about.values.mission.desc': 'Делимся благой вестью',
    'about.values.mission.sub1': 'Делимся благой вестью',
    'about.values.mission.sub2': 'Проявляемая в делах',

    // Statistics
    'statistics.title': 'Наша Община',
    'statistics.subtitle': 'Мы — семья верующих разных возрастов',
    'statistics.total': 'Всего членов',
    'statistics.children': 'Детей',
    'statistics.youth': 'Молодёжи',
    'statistics.adults': 'Взрослых',
    'statistics.seniors': 'Пожилых',
    ...
    'statistics.genderDistribution': 'Распределение по полу',
    'statistics.male': 'Мужчин',
    'statistics.female': 'Женщин',
    ...
    'events.news.content': 'Следите за нашими соцсетями.',
    ...
    'events.baptism.content': 'Свяжитесь с нами для подготовки.',
    ...
    'ministries.loveAndCare.desc': 'Практическая помощь и забота',
  ...
  en: {
    ...
    'about.values.christ.desc': 'Our focus in everything we do',
    'about.values.christ.sub1': 'Who He was, what He did',
    'about.values.christ.sub2': 'What He does now through the Holy Spirit',
    'about.values.bible.title': 'Bible is our truth',
    'about.values.bible.desc': 'God\'s Word is the foundation of our faith',
    'about.values.bible.sub1': 'The Gospel',
    'about.values.bible.sub2': 'All books of the Bible',
    'about.values.discipleship.title': 'Discipleship',
    'about.values.discipleship.desc': 'Growth through mentorship',
    'about.values.discipleship.sub1': 'As mentoring',
    'about.values.discipleship.sub2': 'As fellowship for spiritual growth',
    'about.values.mission.title': 'Mission',
    'about.values.mission.desc': 'Sharing the good news',
    'about.values.mission.sub1': 'Sharing the good news',
    'about.values.mission.sub2': 'Demonstrated in deeds',
    ...
    'ministries.loveAndCare.desc': 'Practical help and care',
  ...
  lv: {
    ...
    'about.values.christ.desc': 'Mūsu fokuss visā, ko darām',
    'about.values.christ.sub1': 'Kas Viņš bija, ko Viņš darīja',
    'about.values.christ.sub2': 'Ko Viņš dara tagad caur Svēto Garu',
    'about.values.bible.title': 'Bībele ir mūsu patiesība',
    'about.values.bible.desc': 'Dieva Vārds ir mūsu ticības pamats',
    'about.values.bible.sub1': 'Evaņģēlijs',
    'about.values.bible.sub2': 'Visas Bībeles grāmatas',
    'about.values.discipleship.title': 'Māceklība',
    'about.values.discipleship.desc': 'Izaugsme caur mentoringu',
    'about.values.discipleship.sub1': 'Kā mentorings',
    'about.values.discipleship.sub2': 'Kā sadraudzība garīgai izaugsmei',
    'about.values.mission.title': 'Misija',
    'about.values.mission.desc': 'Dalāmies ar labo vēsti',
    'about.values.mission.sub1': 'Dalāmies ar labo vēsti',
    'about.values.mission.sub2': 'Parādīta darbos',
    ...
    'statistics.children': 'Bērni',
    'statistics.youth': 'Jaunieši',
    'statistics.adults': 'Pieaugušie',
    'statistics.seniors': 'Seniori',
    'statistics.genderDistribution': 'Dzimumu sadalījums',
    'statistics.male': 'Vīrieši',
    'statistics.female': 'Sievietes',
