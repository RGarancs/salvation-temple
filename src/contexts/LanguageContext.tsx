...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'about.vision.text': 'Храм Спасения прославляет Бога, создавая и взращивая учеников, получивших полное наставление Христа в Латгальском регионе Риги, которые в свою очередь создают новых учеников, что приведет к открытию новой церкви в Латвии в течение 5 лет.',
    ...
    'gallery.subtitle': 'Моменты из жизни нашей церкви',
    'gallery.pageTitle': 'Фотогалерея Храма Спасения',
    'gallery.pageSubtitle': 'Моменты радости, веры и единства нашей общины',
  ...
  en: {
    ...
    'about.vision.text': 'Salvation Temple glorifies God by creating and nurturing disciples fully instructed in Christ in the Latgale region of Riga, who in turn create new disciples, leading to planting a new church in Latvia within 5 years.',
    ...
    'gallery.pageTitle': 'Salvation Temple Photo Gallery',
    'gallery.pageSubtitle': 'Moments of joy, faith, and unity in our community',
